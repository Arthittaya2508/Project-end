...
if (!isset($_SESSION["id"])) {
    ...
    exit(); // Stop the script immediately after changing the path
}
?>
...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav_content">
                        ...
                        <table class="table table-bordered">
                            ...
                            if (($ddt1 != "") & ($ddt2 != "")) {
                                ...
                                $sql = "SELECT o.orderID, o.reg_date, o.cus_name, o.address, o.telephone, o.total_price,
                                           SUM(p.cost * od.orderQty) AS total_cost, GROUP_CONCAT(p.pro_name) AS pro_names,
        ...
        <!--แยกไฟล์footerออกจากตัวและทำการเรียกฟังก์ชันfooterมาเเทน--->
